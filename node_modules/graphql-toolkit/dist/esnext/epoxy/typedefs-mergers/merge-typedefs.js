...
export function mergeTypeDefs(types, config) {
    ...
    const doc = {
        kind: Kind.DOCUMENT,
        definitions: mergeGraphQLTypes(types, Object.assign({ useSchemaDefinition: true, forceSchemaDefinition: false, throwOnConflict: false, commentDescriptions: false }, config)),
    };
    let result;
...
function extendDefinition(type) {
    switch (type.astNode.kind) {
        case Kind.OBJECT_TYPE_DEFINITION:
            return Object.assign(Object.assign({}, type.astNode), { fields: type.astNode.fields.concat(type.extensionASTNodes.reduce((fields, node) => fields.concat(node.fields), [])) });
