...
async function loadDocuments(documentDef, options = {}, cwd = process.cwd()) {
    return await load_typedefs_1.loadTypedefs(documentDef, Object.assign(Object.assign({}, options), { skipGraphQLImport: true, noRequire: true }), exports.NON_OPERATION_KINDS, cwd);
}
