...
function parseDirectiveValue(value) {
    switch (value.kind) {
        ...
        case graphql_1.Kind.OBJECT:
            return value.fields.reduce((prev, v) => (Object.assign(Object.assign({}, prev), { [v.name.value]: parseDirectiveValue(v.value) })), {});
        ...
        for (const field of type.fields) {
            if (field.directives && field.directives.length > 0) {
                ...
                const directives = field.directives.map(d => ({
                    name: d.name.value,
                    args: (d.arguments || []).reduce((prev, arg) => (Object.assign(Object.assign({}, prev), { [arg.name.value]: parseDirectiveValue(arg.value) })), {}),
                }));
